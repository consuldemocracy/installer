...
There are many more variables available check them out [here]((https://github.com/consuldemocracy/installer/blob/2.3.1/group_vars/all))
...
Change the variable [deploy_user](https://github.com/consuldemocracy/installer/blob/2.3.1/group_vars/all#L12) to the username you would like to use.
